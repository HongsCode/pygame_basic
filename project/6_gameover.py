...
ball_images = [
    pygame.image.load(os.path.join(image_path,image_path, "balloon1.png")),
    pygame.image.load(os.path.join(image_path,image_path, "balloon2.png")),
    pygame.image.load(os.path.join(image_path,image_path, "balloon3.png")),
    pygame.image.load(os.path.join(image_path,image_path, "balloon4.png"))
]
...
#게임 종료 메세지/ Timeout(시간 초과), Mission Complete(성공), 
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                #가장 작은 크기의 공이 아니 라면 다음 단계의 공으로 나누기
                if ball_img_idx < 3:
                    #현재 공 크기 정보를 가져옴
